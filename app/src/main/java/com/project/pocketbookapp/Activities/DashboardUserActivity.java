...
import com.project.pocketbookapp.BooksUserFragment;
import com.project.pocketbookapp.Model.CategoryModel;
import com.project.pocketbookapp.R;
import com.project.pocketbookapp.databinding.ActivityDashboardUserBinding;
...
public class DashboardUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.chatBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardUserActivity.this,RequestBookActivity.class));
            }
        });
    }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter{
        ...
        private void addFragment(BooksUserFragment fragment,String title){
            //add fragment passed as parameters in fragmentList
    ...
    private void checkUser() {
        ...
        if(firebaseUser==null){
            binding.subtitleTv.setText(R.string.not_logged);
        }
        else{
