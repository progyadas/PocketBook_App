...
import com.project.pocketbookapp.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void updatePdf() {
        Log.d(TAG,"updatePdf: start updating pdf info into database");
        ...
        ref.child(bookId)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG,"onFailure: failed to update pdf info into database due to "+e.getMessage());
                        progressDialog.dismiss();
