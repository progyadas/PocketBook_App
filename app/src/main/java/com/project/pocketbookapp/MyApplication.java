package com.project.pocketbookapp;

import static com.project.pocketbookapp.Constants.MAX_BYTES_PDF;
   ...
   public static void deleteBook(Context context, String bookId, String bookUrl, String bookTitle) {
        ...
        storageReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Log.d(TAG,"onSuccess:  Deleting from database");
                ...
                .addOnSuccessListener(new OnSuccessListener<StorageMetadata>() {
                    ...
                    public void onSuccess(StorageMetadata storageMetadata) {
                        ...
                        if(mb>=1){
                            ...
                            sizeTv.setText(String.format("%.2f",kb)+"MB");
                        }
                        else{
        ...
        ref.getBytes(MAX_BYTES_PDF)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        Log.d(TAG,"onSuccess: "+pdfTitle+"successfully received the file");
    ...
    public static void downloadBook(Context context,String bookId,String bookTitle, String bookUrl) {
        ...
        storageReference.getBytes(MAX_BYTES_PDF)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG_DOWNLOAD,"onFailure: Download Failure due to"+e.getMessage());
                        progressDialog.dismiss();
                        Toast.makeText(context, "Download failed due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        try{
            ...
            Log.d(TAG_DOWNLOAD,"saveDownloadedBook: Saved to Downloads folder");
            progressDialog.dismiss();
    ...
    public static void addToFavorite(Context context,String bookId){
        ...
        if(firebaseAuth.getCurrentUser()==null){
            //not logged in cannot add to favourites
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(context,"Added to your favorite's list",Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context,"Failed to add to your favorite's list due to "+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    public static void removeFromFavorite(Context context,String bookId){
        ...
        FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
        if(firebaseAuth.getCurrentUser()==null){
            //not logged in cannot remove from favourites
            Toast.makeText(context,"You are not logged in",Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(context,"Removed from your favorite's list",Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context,"Failed to remove from your favorite's list due to "+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
